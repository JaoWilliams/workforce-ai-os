#!/bin/bash
# ============================================================
# Fase 11 (Orquestacion) - Parte 7: test end-to-end (v2)
# ============================================================
# v2: corrige el uso de persist_journal_entry (devuelve una tupla
# (entry, error), no un dict, y no comitea solo -- el test debe
# comitear explicitamente). Ademas agrega una limpieza previa al
# arranque para que sea seguro re-correr el test tras un corte a
# medias (como paso la primera vez).
# Ejecutar: cd /opt/workforce-ai-os && bash fase11_parte7_test.sh
# ============================================================
set -e
REPO_DIR="${REPO_DIR:-/opt/workforce-ai-os}"
cd "$REPO_DIR"

cat > test_payroll_run_e2e.py << 'PYEOF'
"""
